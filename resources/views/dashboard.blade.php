<x-app-layout>
    ...
    @auth
        ...
        <div class="bg-gray-800 text-white max-w-6xl mx-auto lg:px-0 mb-1">
            <div class="text-yellow-400 border-yellow-700 border border-l-8 rounded-md p-2 bg-yellow-700 bg-opacity-30">
    ...
    <div class="max-w-xl flex-1 mx-auto flex flex-wrap flex-col lg:max-w-6xl lg:flex-row ">
        ...
        <div class="w-full flex flex-col lg:flex-row">
            <div class="flex flex-col lg:flex-1 lg:w-1/2" id="task-container">
                <livewire:task />
            ...
            <div class="lg:w-1/2" id="custom-chart-container">
