<x-app-layout>
    <div class="flex justify-center items-center h-screen">
        <div class="relative w-full max-w-md p-8 bg-gray-950 border-2
        border-cyan-500 rounded-none shadow-[0_0_20px_rgba(6,182,212,0.5)] tracking-wider">

            <div class="absolute inset-0 opacity-5 pointer-events-none"
                style="background-size: 20px 20px; background-image: linear-gradient(to right, #06b6d4 1px,
            transparent 1px), linear-gradient(to bottom, #06b6d4 1px, transparent 1px);"></div>

            <div class="text-center mb-8 relative">
                <h1 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500
    to-cyan-400 italic uppercase drop-shadow-[0_2px_10px_rgba(244,63,94,0.6)]">
                    PlanPacer
                </h1>
